...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    "proposalBuilder.extractData.billedPowerP1": "Мощность P1, кВт",
    "proposalBuilder.extractData.billedPowerP2": "Мощность P2, кВт",
    "proposalBuilder.extractData.billedPowerP3": "Мощность P3, кВт",
    "proposalBuilder.extractData.consumptionP1": "Потребление P1, кВтч",
    "proposalBuilder.extractData.consumptionP2": "Потребление P2, кВтч",
    "proposalBuilder.extractData.consumptionP3": "Потребление P3, кВтч",
  ...
  es: {
    ...
    "proposalBuilder.extractData.billedPowerP1": "Potencia Facturada P1, kW",
    "proposalBuilder.extractData.billedPowerP2": "Potencia Facturada P2, kW",
    "proposalBuilder.extractData.billedPowerP3": "Potencia Facturada P3, kW",
    "proposalBuilder.extractData.consumptionP1": "Consumo P1, kWh",
    "proposalBuilder.extractData.consumptionP2": "Consumo P2, kWh",
    "proposalBuilder.extractData.consumptionP3": "Consumo P3, kWh",
